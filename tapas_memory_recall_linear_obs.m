function [logp, yhat, res] = tapas_memory_recall_linear_obs(r, infStates, ptrans)
...
%
%   - High similarity + "new" response in previous trials = likely miss.
%     Then beliefs are biased towards responding "old" in the next trial,
%     by an amount that is proportional to the degree of similarity in the
%     previous miss.
%   - Low similarity + "old" response in previous trials = likely false
%     alarm. Then beliefs are biased towards responding "new" in the next
%     trial, by an amount that is proportional to the degree of similarity
%     in the previous false alarm.
%
