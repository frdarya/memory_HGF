function c = tapas_memory_recall_asymmetric_obs_config
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%
...
% Model name
c.model = 'tapas_memory_recall_asymmetric_obs';
...
% ---------------------------------------------------------
% 5. Kappa (kappa) - Asymetry parameter
% ---------------------------------------------------------
% Interpretation: Asymmetry in error detection
% κ = 1: Symmetric detection (linear)
% κ > 1: Misses more detectable than false alarms
% κ < 1: False alarms more detectable than misses
% Range: (0, +∞) - positive only
% Prior: Transformed via log(), centered at symmetric model
c.logkappamu = log(1);     % Prior mean: exp(0) = 1 (symmetric)
c.logkappasa = 0.5;        % Moderate variability

%-----------------------------------------------
% Gather prior settings in vectors
% Order corresponds to: [be, nu, gamma, alpha, kappa]
c.priormus = [
...
% Model filehandle
c.obs_fun = @tapas_memory_recall_asymmetric_obs;

% Handle to function that transforms observation parameters to their native space
% from the space they are estimated in
c.transp_obs_fun = @tapas_memory_recall_asymmetric_obs_transp;
return;
